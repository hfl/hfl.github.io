...
~~~
一个 [链接](http://kramdown.gettalong.org)
到kramdown主页的链接就这样生成了。
~~~

当然，你也可以添加一个链接的提示信息：

~~~
一个[链接](http://karamdown.gettalong.org "karamdown 主页")
到kramdown主页的链接诶就这样生成了。
~~~
...
~~~
这是一个<span sytle="color:red">红色文字</span>。
~~~
